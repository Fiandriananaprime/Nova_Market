...
const StoreProductCard = ({product}:{product:Product}) =>  {
    ...
    return (
            <div key={product.id} className="bg-card border border-border rounded-xl overflow-hidden hover:shadow-md hover:border-[#5ABCB9]/30 transition-all group cursor-pointer" onClick={() => navigate(`/admin/products/${product.id}`)}>

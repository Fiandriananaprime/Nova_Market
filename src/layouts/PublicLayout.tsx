        ...
        <div className="flex items-center justify-between h-16">
         ...
         <div className="hidden md:flex items-center gap-1">
            {[
              ...
              ['#FeaturedSellers', t("Sellers")],
              ['#FeaturedProducts', t("Products")],
            ].map(([href, label]) => (
              <a
                key={href}
                href={href}
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            {userRole ? (
              ...
              <>
                <Button variant="ghost" size="sm" onClick={() => navigate('/login')}>{t("Sign in")}</Button>
                <Button variant="primary" size="sm" onClick={() => navigate('/register')}>{t("Create account")}</Button>
              </>
            )}
          </div>
        ...
        <div className="md:hidden border-t border-border bg-card px-4 py-3 space-y-1">
          ...
          <div className="flex gap-2 pt-2">
            {userRole ? (
              ...
              <>
                <Button variant="outline" size="sm" className="flex-1" onClick={() => { navigate('/login'); setMobileOpen(false); }}>{t("Sign in")}</Button>

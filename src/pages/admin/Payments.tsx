  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard title="Platform commission" value="28.4M Ar" change={14.2} icon={<TrendingUp className="w-5 h-5" />} color="#5ABCB9" />
        <StatCard title="Transactions" value="8,432" change={9.3} icon={<CreditCard className="w-5 h-5" />} color="#0077B6" />
        <StatCard title="Mobile money" value="79%" change={2.1} icon={<Smartphone className="w-5 h-5" />} color="#5ABCB9" />
      </div>

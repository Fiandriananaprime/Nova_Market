...
export default function AddProduct() {
  ...
  const handleSave = async () => {
    ...
    setLoading(false);
    toast(t("Product saved successfully"));
      ...
      <div className="grid md:grid-cols-3 gap-5">
        <div className="md:col-span-2 space-y-4">
          ...
          <Section title={t("Pricing")}>
            <div className="grid grid-cols-2 gap-3">
              <Input label={t("Price (Ar)")} type="number" placeholder="1299000" />
              <Input label={t("Promotional price (Ar)")} type="number" placeholder={t("Optional")} />
            </div>
          </Section>
          ...
          <Section title={t("Inventory")}>
            <div className="grid grid-cols-3 gap-3">
              ...
              <Input label={t("Stock")} type="number" placeholder="100" />
              <Input label={t("Low stock threshold")} type="number" placeholder="10" />
            </div>
          </Section>
          ...
          <Section title={t("Shipping")}>
            <div className="grid grid-cols-2 gap-3">
              <Input label={t("Weight (g)")} type="number" placeholder="200" />
              <Input label={t("Dimensions (cm)")} placeholder="15x10x5" />
            </div>
          </Section>
        </div>
